...
public class ViewHtmlFormFragmentController {
	...
	public void controller(@FragmentParam("encounter") Encounter encounter, FragmentModel model, HttpSession httpSession,
	        UiUtils ui, @SpringBean ResourceFactory resourceFactory) throws Exception {
		...
		FormEntrySession fes = new FormEntrySession(encounter.getPatient(), encounter, FormEntryContext.Mode.VIEW, hf,
		        httpSession);
