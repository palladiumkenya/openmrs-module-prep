...
/**
 * Evaluates Number of days late Data Definition
 */
@Handler(supports = NumberOfDaysLateDataDefinition.class, order = 50)
public class NumberOfDaysLateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select t.patient_id,\n"
		        + " DATEDIFF(curdate(), mid(max(concat(t.visit_date, t.appointment_date)), 11)) as Number_of_days_late\n"
