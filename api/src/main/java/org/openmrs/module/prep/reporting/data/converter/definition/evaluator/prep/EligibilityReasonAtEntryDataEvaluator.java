...
public class EligibilityReasonAtEntryDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select h.patient_id,concat_ws(',',COALESCE(if(sexual_partner_hiv_status='HIV Positive',1,null)),COALESCE(if(sex_with_multiple_partners='Yes',9,null)),\n"
