...
/**
 * Evaluates FollowupHTSResults EncounterDataEvaluator
 */
@Handler(supports = FollowupHTSResultsDataDefinition.class, order = 50)
public class FollowupHTSResultsDataEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select pf.encounter_id,ht.final_test_result as hiv_status\n"
