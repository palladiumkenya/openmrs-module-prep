 ...
 */
@Component
public class PrepVelocityContentProvider implements VelocityContextContentProvider {
	
	@Autowired
	private UiUtils ui;
	
	/**
	 * @see org.openmrs.module.htmlformentry.velocity.VelocityContextContentProvider#populateContext(org.openmrs.module.htmlformentry.FormEntrySession,
	 *      VelocityContext)
	 */
	@Override
	public void populateContext(FormEntrySession session, VelocityContext velocityContext) {
		
		velocityContext.put(EmrConstants.MODULE_ID, new PrepVelocityFunctions(session));
