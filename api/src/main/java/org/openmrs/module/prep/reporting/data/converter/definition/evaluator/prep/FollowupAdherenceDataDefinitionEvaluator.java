 ...
 */
@Handler(supports = FollowupAdherenceDataDefinition.class, order = 50)
public class FollowupAdherenceDataDefinitionEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id,adherence_outcome from kenyaemr_etl.etl_prep_followup;";
