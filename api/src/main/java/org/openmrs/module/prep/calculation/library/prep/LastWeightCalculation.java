 ...
 */
public class LastWeightCalculation extends AbstractPatientCalculation {
	...
	public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues,
		...
		for (Integer ptId : cohort) {
			Obs weightObs = EmrCalculationUtils.obsResultForPatient(currentWeight, ptId);
			result.put(ptId, new SimpleResult(weightObs, this));
		}
		return result;
	}
}
