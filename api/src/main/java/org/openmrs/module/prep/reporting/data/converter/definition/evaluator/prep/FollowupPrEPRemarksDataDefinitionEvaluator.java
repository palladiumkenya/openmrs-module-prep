 ...
 */
@Handler(supports = FollowupPrEPRemarksDataDefinition.class, order = 50)
public class FollowupPrEPRemarksDataDefinitionEvaluator implements EncounterDataEvaluator {
	...
	public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context)
		...
		String qry = "select encounter_id,clinical_notes from kenyaemr_etl.etl_prep_followup;";
