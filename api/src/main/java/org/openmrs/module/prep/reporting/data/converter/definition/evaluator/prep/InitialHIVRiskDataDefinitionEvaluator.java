...
import org.openmrs.module.prep.reporting.data.converter.definition.prep.InitialHIVRiskDataDefinition;
...
/**
 * Evaluates InitialHIVRiskDataDefinition DataDefinition
 */
@Handler(supports = InitialHIVRiskDataDefinition.class, order = 50)
public class InitialHIVRiskDataDefinitionEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select ba.patient_id,\n"
		        + "(case mid(min(concat(ba.visit_date,ba.assessment_outcome)),11) when 'Risk' then 'Yes'\n"
